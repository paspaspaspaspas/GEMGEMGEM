...
public class EntryPoint {
	 ...
	 * 
	 * These windows are visible only one at the time since each
	 * of them represents one different point of the game.
	 * 
	 * They are also linked together in order to be able to switch from one to
	 * the other depending on the state of the game.
	 * @param args
	 */
